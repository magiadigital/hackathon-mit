// export namespace org.hyperledger.composer.system{
   ...
   export abstract class SystemRegistry extends Registry {
   }
   export class AssetRegistry extends SystemRegistry {
   }
   export class ParticipantRegistry extends SystemRegistry {
   }
   export class TransactionRegistry extends SystemRegistry {
   }
   ...
   export class HistorianRegistry extends SystemRegistry {
   }
   export abstract class RegistryTransaction extends Transaction {
      registryType: string;
      registryId: string;
   }
   export class ResourceId extends Asset {
      id: string;
   }
